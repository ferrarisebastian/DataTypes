...
Estos Tipo de datos se guardan en memoria en un espacio llamado STACK o PILA:
...
Estos Tipo de datos se guardan en memoria en un espacio llamado HEAP o MONTON:
